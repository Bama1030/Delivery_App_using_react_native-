    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                        ...
                        <View style={styles.view3}>
                            ...
                            <View style={styles.view4}>
                                <Icon
                                    ...
                                    size={15}
                                />
                                <Text style={styles.text4}>{restaurantsData[id].avarageReview}</Text>
                                ...
                                <Icon
                                    ...
                                    size={15}
                                />
                                <Text style={styles.text5}>{restaurantsData[id].farAway} mi away</Text>
                            </View>
                ...
                {
                    index ===1 &&
                    <InfoScreen onPress={menuPressed} />
                }
                {
                    index ===2 &&
                    <ReviewScreen onPress={menuPressed} />
                }
