...
class PreferanceScreen extends Component {
    constructor(props){
      super(props);
      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.header}>
            <Image
              ...
              source={{ uri: "https://media.istockphoto.com/id/477596753/photo/homemade-southern-fried-chicken.jpg?s=612x612&w=0&k=20&c=8b_5KjKmmO34ChsqVZN4-1YlDXyVJNlKh3w6qtVjR88=" }}
            />
          </View>
                ...
                >
                  <View style={styles.view4}>
                    <View style={styles.view19}>
                      ...
                      <Text style={styles.text6}>Rs {items.price.toFixed(2)}</Text>
                    </View>
                  </View>
                  </TouchableOpacity>
                )}
        ...
        <View style={styles.view17}>
          <View style={styles.view18}>
            <Text style={styles.text10}>Add 1 to Cart Rs 100.00</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  bar: {
    ...
    marginTop: Platform.OS === 'ios' ? 28 : 58,
    height: 40,
    alignItems: 'center',
...
export default PreferanceScreen;